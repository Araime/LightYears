...
namespace ly
{
	UFO::UFO(World* owningWorld, const sf::Vector2f& velocity, const std::string& texturePath, float rotationSpeed)
		...
		mShooter1(new BulletShooter(this, 0.7f, {0.f, 0.f}, -60.f)),
		mShooter2(new BulletShooter(this, 0.7f, { 0.f, 0.f }, 60.f)),
		mShooter3(new BulletShooter(this, 0.7f, { 0.f, 0.f }, 180.f)),
